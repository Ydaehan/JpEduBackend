...
class AuthController extends Controller
{
  ...
  #[OpenApi\Response(factory: ErrorValidationResponse::class, description: '유효성 검사 실패', statusCode: 403)]
  public function register(Request $request)
  {
    ...
    $user = User::create([
      ...
      'password' => Hash::make($validator->get('password')),
      'phone' => $validator->get('phone'),
      'birthday' => $validator->get('birthday'),
      //   'verification_code' => sha1(time())
    ]);

    if ($validator->get('role') !== null) {
      $user->role = $validator->get('role');
      $user->save();
    }
  ...
  #[OpenAPI\Response(factory: LoginResponse::class, description: '로그인 성공', statusCode: 200)]
  #[OpenApi\Response(factory: ErrorValidationResponse::class, description: '유효성 검사 실패', statusCode: 403)]
